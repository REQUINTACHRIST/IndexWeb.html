...
<body>
    <heading>
        <h1>Donut lovers</h1>
        <p>Life is better with filings</p>
    </heading>
    <nav>
        <a href="#">Home</a>
    </nav>
